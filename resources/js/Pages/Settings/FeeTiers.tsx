...
import { FeeTier, FeeTiersPageProps } from '@/types';

export default function FeeTiers({ tiers }: FeeTiersPageProps) {
  ...
  return (
    <AppLayout>
      <Head title="Fee Tiers" />

      <div className="mb-6">
        <h1 className="font-display text-2xl font-bold md:text-3xl">Fee Tiers</h1>
